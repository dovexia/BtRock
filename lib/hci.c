...
int hci_le_cmd_set_random_address(bdaddr_t * p_bdaddr)
{
	...
	rq.event  = 0;
    rq.cparam = &cmd_param;
	rq.clen   = sizeof(le_set_random_address_cp);
	rq.rparam = &status;
	rq.rlen = sizeof(status);
            ...
            uint8_t direct_bdaddr_type, bdaddr_t * direct_bdaddr, uint8_t chan_map, uint8_t filter)
{
	...
	rq.event  = 0;
    rq.cparam = &cmd_param;
	rq.clen   = sizeof(le_set_advertising_parameters_cp);
	rq.rparam = &status;
	rq.rlen = sizeof(status);
...
int hci_le_cmd_set_advertising_enable(uint8_t enable)
{
	...
	rq.event  = 0;
    rq.cparam = &cmd_param;
	rq.clen   = sizeof(le_set_advertise_enable_cp);
	rq.rparam = &status;
	rq.rlen = sizeof(status);
...
int hci_le_cmd_set_scan_parameters(uint8_t type, uint16_t interval, uint16_t window, uint8_t own_bdaddr_type, uint8_t filter)
{
	...
	rq.event  = 0;
    rq.cparam = &cmd_param;
	rq.clen   = sizeof(le_set_scan_parameters_cp);
	rq.rparam = &status;
	rq.rlen = sizeof(status);
