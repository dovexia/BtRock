...
typedef struct {
	uint8_t		status;
} __attribute__ ((packed)) le_common_rp;
#define LE_COMMON_RP_SIZE 1
...
typedef struct {
    ...
    uint16_t    max_latency[1];
    uint16_t    supervision_timeout[1];
    uint16_t    min_ce_length[1];
    uint16_t    max_ce_length[1];
} __attribute__ ((packed)) le_extended_create_connection_v1_cp;
#define OCF_LE_EXTENDED_CREATE_CONNECTION_SIZE_V1 38
...
typedef struct {
    ...
    uint16_t    min_ce_length[1];
    uint16_t    max_ce_length[1];
} __attribute__ ((packed)) ocf_le_extended_create_connection_v2_cp;
#define OCF_LE_EXTENDED_CREATE_CONNECTION_V2_SIZE 38
...
} __attribute__ ((packed)) le_setup_iso_data_path_cp;
