...
#define LE_SET_DATA_LENGTH_CP_SIZE 5
...
#define LE_READ_MAXIMUM_DATA_LENGTH_RP_SIZE 1
...
typedef struct {
    uint8_t     Enable;
    uint8_t     Num_Sets;
    uint8_t     Advertising_Handle[0];  // Num_Sets *1
    uint16_t    Duration[0];    // Num_Sets *1
    uint8_t     Max_Extended_Advertising_Events[0];     // Num_Sets *1
} __attribute__ ((packed)) le_set_extended_advertising_enable_cp;
#define LE_SET_EXTENDED_ADVERTISING_ENABLE_CP_SIZE 5
...
#define LE_READ_MAXIMUM_ADVERTISING_DATA_LENGTH_RP_SIZE 3
...
#define LE_SET_PERIODIC_ADVERTISING_DATA_CP_SIZE   12
...
#define LE_SET_PERIODIC_ADVERTISING_ENABLE_CP_SIZE   12
...
#define LE_SET_EXTENDED_SCAN_PARAMETERS_CP_SIZE
...
#define LE_SET_EXTENDED_SCAN_ENABLE_CP_SIZE
...
#define LE_SET_EXTENDED_SCAN_ENABLE_V1_CP_SIZE
...
#define LE_SET_EXTENDED_SCAN_ENABLE_V1_CP2_SIZE
...
#define LE_PERIODIC_ADVERTISING_CREATE_SYNC_CP_SIZE 8
...
#define LE_READ_TRANSMIT_POWER_RP_SIZE 2
...
#define LE_SET_PRIVACY_MODE_CP_SIZE 4
...
#define LE_SET_CONNECTIONLESS_CTE_TRANSMIT_PARAMETERS_CP_SIZE 4
...
#define LE_SET_CONNECTIONLESS_IQ_SAMPLING_ENABLE_CP_SIZE 2
typedef struct {
    uint8_t     status;
    uint16_t     sync_handle;
} __attribute__ ((packed)) le_set_connectionless_iq_sampling_enable_rp;
#define LE_SET_CONNECTIONLESS_IQ_SAMPLING_ENABLE_RP_SIZE 2
...
#define LE_SET_CONNECTION_CTE_TRANSMIT_PARAMETERS_CP_SIZE 6
typedef struct {
    uint8_t     status;
    uint16_t    connection_handle;
...
#define LE_CONNECTION_CTE_REQUEST_ENABLE_CP_SIZE 6
typedef struct {
    uint8_t     status;
    uint16_t    connection_handle;
...
#define LE_PERIODIC_ADVERTISING_SYNC_TRANSFER_CP_SIZE 3
typedef struct {
    uint8_t    status;
    uint16_t   connection_handle;
...
#define LE_PERIODIC_ADVERTISING_SET_INFO_TRANSFER_CP_SIZE 3
typedef struct {
    uint8_t    status;
    uint16_t   connection_handle;
...
#define LE_SET_DEFAULT_PERIODIC_ADVERTISING_SYNC_TRANSFER_PARAMETERS_CP_SIZE 8
...
#define LE_READ_ISO_TX_SYNC_CP_SIZE 1
typedef struct {
    uint8_t     status;
    uint16_t    connection_handle;
...
#define LE_READ_ISO_TX_SYNC_RP_SIZE 1
...
#define LE_SET_CIG_PARAMETERS_CP_SIZE
typedef struct {
    uint8_t     status;
    uint8_t     cig_id;
    uint8_t     cis_count;
...
#define LE_SET_CIG_PARAMETERS_RP_SIZE
...
#define LE_SET_CIG_PARAMETERS_TEST_CP_SIZE
typedef struct {
    uint8_t     status;
    uint8_t     cig_id;
    uint8_t     cis_count;
...
#define LE_SET_CIG_PARAMETERS_TEST_RP_SIZE
...
#define LE_REJECT_CIS_REQUEST_CP_SIZE 1
typedef struct {
    uint8_t     status;
    uint16_t    connection_handle;
...
#define LE_CREATE_BIG_TEST_CP_SIZE
...
#define LE_ISO_READ_TEST_COUNTERS_RP_SIZE   3
...
#define LE_READ_ISO_LINK_QUALITY_RP_SIZE   2
...
#define LE_ENHANCED_READ_TRANSMIT_POWER_LEVEL_RP_SIZE   2
...
#define LE_SET_PATH_LOSS_REPORTING_PARAMETERS_CP_SIZE   2

typedef struct {
    uint8_t     status;
    uint16_t    connection_handle;
} __attribute__ ((packed)) le_set_path_loss_reporting_parameters_rp;
#define LE_SET_PATH_LOSS_REPORTING_PARAMETERS_RP_SIZE   2
...
#define LE_SET_PATH_LOSS_REPORTING_ENABLE_RP_SIZE   2
...
#define LE_SET_TRANSMIT_POWER_REPORTING_ENABLE_CP_SIZE   2
typedef struct {
    uint8_t     status;
    uint16_t    connection_handle;
} __attribute__ ((packed)) le_set_transmit_power_reporting_enable_rp;
#define LE_SET_TRANSMIT_POWER_REPORTING_ENABLE_RP_SIZE   2
...
#define OCF_LE_SET_DEFAULT_SUBRATE_CP_SIZE   2
...
#define OCF_LE_SUBRATE_REQUEST_CP_SIZE   2
...
#define LE_SET_PERIODIC_ADVERTISING_SUBEVENT_DATA_CP_DIZE   2
...
#define LE_SET_PERIODIC_ADVERTISING_RESPONSE_DATA_CP_SIZE   2

typedef struct {
    uint8_t     status;
    uint16_t    sync_handle;
} __attribute__ ((packed)) le_set_periodic_advertising_response_data_rp;
#define LE_SET_PERIODIC_ADVERTISING_RESPONSE_DATA_RP_SIZE   2
...
#define LE_SET_PERIODIC_SYNC_SUBEVENT_CP_SIZE   2

typedef struct {
    uint8_t     status;
    uint16_t    sync_handle;
} __attribute__ ((packed)) le_set_periodic_sync_subevent_rp;
#define LE_SET_PERIODIC_SYNC_SUBEVENT_RP_SIZE   2
